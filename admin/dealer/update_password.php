...
<?php
    ...
    $select_user = mysqli_query($localhost,"SELECT `id`,`name` FROM `users` WHERE `id`='$dealer_id' ");
...
<head>
    ...
    $meta_single_page_title = 'Change Dealer Password - ';
    $meta_single_page_desc = 'Change Dealer Password - ';
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="page-header-left">
                                <h3>Change Dealer Password <small><?php echo $fetch_user['name']?></small> </h3>
                            </div>
                            <br>
                        </div>
                    </div>
                                ...
                                <div class="card-body">
                                    <div class="product-adding">
                                        ...
                                        <form class="form add-product-form" data-action-after=2 data-redirect-url="" method="POST"
                                                action="<?php echo URL ?>dealer/ajax/controller/updateDealerController.php">
                                            ...
                                            <div class="col-xl-12">
                                                <div class="row">
                                                    ...
                                                    <div class="col-xs-12 col-lg-12 text-right">
                                                        <input type="hidden" name="dealer_id" value="<?php echo $fetch_user['id']?>">
                                                        <input type="hidden" name="update_dealer_pswd">
