...
$select_size = mysqli_query($localhost,"SELECT `id`, `name` FROM `product_size_categories` WHERE `id`='$size_id'");
...
<head>
    ...
    $meta_single_page_title = 'Update Size Category- ';
    $meta_single_page_desc = 'Update Size Category- ';
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="product-adding">
                                    ...
                                    <form class="form add-product-form" data-action-after=2 data-redirect-url="<?php echo URL?>sizeCategories/sizeList.php" method="POST"
                                            action="<?php echo URL ?>sizeCategories/ajax/controller/updateSizeController.php">
                                        ...
                                        <div class="col-xl-12">
                                            <div class="row">
                                                ...
                                                <div class="col-xs-12 col-lg-12 text-right">
                                                    ...
                                                    <a href="<?php echo URL ?>sizeCategories/sizeList.php" class="btn btn-transprent"> <i class="fa fa-chevron-left"></i> Back</a>
