...
$select_pro = mysqli_query($localhost,"SELECT `item_code` FROM `products` WHERE `id`='$product_id' ");
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="page-header-left">
                                <h3>Product Sizes 
                                <br>
                                <small>For Product <?php echo $fetch_pro['item_code']?></small>
                                </h3>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-12 card-body"> 
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-1 col-sm-1">
                                <input type="hidden" name="assign_sizes">
