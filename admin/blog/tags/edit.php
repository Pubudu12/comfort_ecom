...
$select = mysqli_query($localhost, "SELECT * FROM `blog_type` WHERE `id` = '$tag_id' ");
...
<head>
    ...
    $meta_single_page_title = 'Edit Blog Tag - ';
    $meta_single_page_desc = 'Edit Blog Tag - ';
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="page-header-left">
                                <h3>Edit Blog Tag
                                    <small><?php echo $fetch['type'] ?></small>
                                </h3>
                            </div>
                        </div>
                    </div>
                                        ...
                                        <div class="col-xl-12">
                                            <div class="row">
                                                ...
                                                <div class="col-xs-12 col-lg-12 text-right">
                                                    ...
                                                    <input type="hidden" name="edit_blog_tag" value="<?php echo $fetch['id'] ?>">
