...
<head>
    ...
    $meta_single_page_title = 'Post Categories - ';
    $meta_single_page_desc = 'Post Categories - ';
                            ...
                            <div class="col-md-12 card-body"> 
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xs-12 col-md-12 col-lg-12 text-right">
                                        <a href="<?php echo URL ?>blog/category/create" class="btn btn-secondary create-btn1"> Create Post Category</a>
                                        <br>&nbsp;
                                    </div>
                                    ...
                                    <div class="col-md-12 col-sm-12">
                                        <table class="dataTableCall" 
                                                ...
                                                data-url = '<?php echo URL ?>blog/categories/ajax/categories-list.php'
