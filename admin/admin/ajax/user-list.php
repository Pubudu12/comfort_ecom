...
while( $row = mysqli_fetch_array($query) ) {  // preparing an array
	$nestedData=array(); 
		...
		$delete_btn = '<button  class="btn btn-sm btn-danger fa fa-trash-o"
                        ...
                        data-id="'.$user_id.'" 
                        data-refresh='.URL.'" 
                        data-url="'.URL.'admin/ajax/controller/deleteUserController.php" 
						data-key="delete_user"></button>';
						
		$change_pswd = '<a href="'.URL.'admin/update_password.php?id='.$user_id.'" class="btn btn-inverse-warning btn-sm">Change Password</a>';
